            ...
            <CardContent className="p-0 text-left">
               <div className="flex flex-col md:flex-row md:items-center">
                  ...
                  <div className="p-6 flex flex-1 items-center gap-6">
                     <div className="size-16 rounded-2xl bg-[var(--color-primary)]/5 border border-[var(--color-primary)]/10 flex items-center justify-center text-3xl font-semibold text-[var(--color-primary)] group-hover:bg-[var(--color-primary)] group-hover:text-white transition-all shadow-inner">
                        {item.name[0]}
                     </div>
                     <div>
                        ...
                        <div className="flex items-center gap-2 mt-1.5">
                           ...
                           <p className="text-sm text-slate-500 font-semibold uppercase tracking-tighter">Group {item.group}  •  <span className="text-slate-400 font-medium">{item.students} Students</span></p>
                        </div>
                     </div>
                  </div>
