        ...
        {stats.map((item, idx) => (
          <Card key={idx} className="border-border shadow-sm bg-white overflow-hidden text-left relative group hover:border-[var(--color-primary)] transition-all">
            ...
            <div className="p-6">
               ...
               <h3 className="text-3xl font-black text-slate-900 mt-1 tracking-tighter">{item.value}</h3>
            </div>
          </Card>
        ))}
      </div>
                        ...
                        {[
                           ...
                           <tr key={idx} className="hover:bg-slate-50/50 transition-colors">
                              ...
                              <td className="px-6 py-4 whitespace-nowrap text-right">
                                 <span className={cn("px-2.5 py-1 rounded-full text-[9px] font-black uppercase tracking-widest", item.color)}>
                                    {item.risk}
                                 </span>
                              </td>
                           </tr>
                     ...
                     <div key={idx} className="p-5 hover:bg-slate-50 transition-colors group">
                        <div className="flex justify-between items-start mb-2">
                           ...
                           <span className={cn(
                              ...
                              group.risk === 'Critical' ? 'text-red-500' : group.risk === 'Elevated' ? 'text-amber-500' : 'text-blue-500'
                           )}>{group.risk}</span>
                        </div>
                        ...
                        <div className="mt-3 flex items-center justify-between">
                           ...
                           <Button variant="ghost" size="sm" className="h-7 px-3 text-[10px] font-black uppercase tracking-widest text-[var(--color-primary)] bg-[var(--color-primary)]/5">Notify Tutor</Button>
                        </div>
                     </div>
                  ))}
               </div>
