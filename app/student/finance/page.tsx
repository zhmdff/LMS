    ...
    <div className="flex flex-col gap-6 text-left">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card className="border-border shadow-sm bg-white p-6 flex flex-col gap-1 text-left relative overflow-hidden group">
          ...
          <p className="text-3xl font-black text-slate-900">4,800 AZN</p>
        ...
        <Card className="border-border shadow-sm bg-white p-6 flex flex-col gap-1 text-left relative overflow-hidden group">
          ...
          <p className="text-3xl font-black text-red-600">1,415 AZN</p>
        ...
        <Card className="border-border shadow-sm bg-white p-6 flex flex-col gap-1 text-left relative overflow-hidden group">
          ...
          <p className="text-3xl font-black text-blue-600">State Funded</p>
        ...
        <Card className="border-border shadow-sm bg-[var(--color-primary)] p-6 flex flex-col gap-1 text-left relative overflow-hidden group text-white">
          ...
          <p className="text-2xl font-black uppercase">Quick Pay</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  {transactions.map((trx) => (
                    <tr key={trx.id} className="hover:bg-slate-50 transition-colors group">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right">
                        <div className={cn("px-2.5 py-1 rounded-full text-[9px] font-black uppercase tracking-widest border inline-flex items-center gap-1.5", trx.status === "Paid" ? "bg-green-50 text-green-700 border-green-100" : "bg-amber-50 text-amber-700 border-amber-100")}>
        ...
        <div className="space-y-6">
          <Card className="border-border shadow-sm bg-slate-900 text-white overflow-hidden p-8 text-center flex flex-col items-center">
            ...
            <p className="text-xs text-slate-400 mt-2 font-medium leading-relaxed mb-8">Pay your tuition directly via the portal using any local bank card. Secure processing provided by University Central Bank.</p>
            <Button className="w-full h-12 bg-white text-slate-900 font-black uppercase text-[11px] tracking-widest hover:bg-slate-100 shadow-xl border-none">Launch Terminal</Button>
          </Card>
