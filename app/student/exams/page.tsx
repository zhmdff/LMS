                  ...
                  <div key={exam.id} className="p-6 flex flex-col md:flex-row md:items-center justify-between gap-6 hover:bg-slate-50 transition-colors group">
                    <div className="flex items-center gap-6">
                      <div className="size-16 rounded-3xl bg-slate-900 text-white flex flex-col items-center justify-center shrink-0 shadow-lg group-hover:bg-[var(--color-primary)] transition-colors">
                        <span className="text-[10px] font-black uppercase opacity-70">MAR</span>
                    ...
                    <Button className="h-11 bg-white border border-border text-slate-700 font-black uppercase text-[10px] tracking-widest px-8 hover:bg-[var(--color-primary)] hover:text-white transition-all shadow-sm">Hall Entry Details</Button>
                  </div>
                ))}
              </div>
            </CardContent>
        ...
        <div className="space-y-6">
          <Card className="border-border shadow-sm bg-slate-900 text-white overflow-hidden">
            <CardContent className="p-8 text-center flex flex-col items-center">
              ...
              <p className="text-xs text-slate-400 mt-2 font-medium leading-relaxed mb-8">Ensure you have your physical student ID and the digital exam permit downloaded for scanning at the hall entrance.</p>
              <Button className="w-full h-12 bg-white text-slate-900 font-black uppercase text-[11px] tracking-widest hover:bg-slate-50 shadow-xl border-none">Rules of Conduct</Button>
            </CardContent>
          </Card>
          ...
          <Card className="border-border shadow-sm bg-amber-50 border-amber-100 p-6 flex gap-4 text-left">
            ...
            <div className="space-y-1">
              ...
              <p className="text-[11px] text-amber-700 font-medium leading-relaxed">Appeals for Kollekvium results must be submitted within 72 hours of score publication. Visit the Requests module to file an appeal.</p>
            </div>
          </Card>
