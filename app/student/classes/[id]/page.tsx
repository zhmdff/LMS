    ...
    <div className="flex flex-col gap-6 text-left">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-white p-8 rounded-3xl border border-border shadow-sm">
        <div className="flex items-center gap-6">
           <div className="size-20 rounded-[2.5rem] bg-[var(--color-primary)] text-white flex items-center justify-center text-4xl font-semibold shadow-2xl">
              {subject.name[0]}
           </div>
           <div className="flex flex-col gap-1">
              ...
              <div className="flex items-center gap-4 text-slate-400 font-medium text-sm">
                 <span className="flex items-center gap-1.5"><User className="h-4 w-4 text-slate-300" /> {subject.teacher}</span>
                    ...
                    <tr key={i} className="hover:bg-slate-50 transition-colors">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right">
                        <span className={cn(
                          ...
                          log.status === 'q.b' ? "text-red-500" : "text-[var(--color-primary)]"
                        )}>
                          {log.status === 'q.b' 
                            ? 'q.b' 
                  ...
                  {[
                    ...
                    <tr key={i} className="hover:bg-slate-50 transition-colors">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-center">
                        <span className={cn(
                          "px-2.5 py-1 rounded-full text-[10px] font-semibold uppercase tracking-widest",
                          k.status === 'Finalized' ? "bg-green-50 text-green-700" : "bg-blue-50 text-blue-700"
                        )}>{k.status}</span>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-right">
          ...
          <Card className="border-border shadow-sm bg-white overflow-hidden max-w-2xl">
             <div className="p-10 text-center flex flex-col items-center">
                ...
                <p className="text-sm text-slate-400 font-medium leading-relaxed max-w-sm mb-12">
                   This is a one-time assessment with a maximum weight of <span className="text-[var(--color-primary)] font-semibold">15.0 points</span>. 
                   Topic must be approved by the lecturer before submission.
                </p>
          ...
          <Card className="border-border shadow-sm bg-white overflow-hidden max-w-2xl border-t-8 border-t-[var(--color-primary)]">
             <div className="p-10">
                <div className="flex justify-between items-start mb-10">
                   <div className="flex flex-col gap-1">
                      <h3 className="text-3xl font-semibold text-slate-900 tracking-tighter">Final Assessment</h3>
                ...
                <div className="flex flex-col items-center bg-slate-900 rounded-[2.5rem] p-10 text-white shadow-2xl skew-x-[-1deg]">
                   ...
                   <p className="text-7xl font-semibold tracking-tighter">Not Ready</p>
