          ...
          <Card key={group.id} className="border-border shadow-sm hover:border-[var(--color-primary)] transition-all group bg-white overflow-hidden">
            <div className="p-6">
              <div className="flex justify-between items-start mb-6">
                 <div>
                    <h3 className="text-3xl font-black text-slate-900 tracking-tighter group-hover:text-[var(--color-primary)] transition-colors">{group.name}</h3>
                    <p className="text-xs font-bold text-slate-500 mt-1">{group.specialty}</p>
                 </div>
                 <div className="bg-[var(--color-primary)]/5 text-[var(--color-primary)] px-2.5 py-1 rounded-full text-[9px] font-black uppercase tracking-widest border border-[var(--color-primary)]/10">
              ...
              <div className="flex gap-2">
                 <Button className="flex-1 h-11 bg-[var(--color-primary)] text-white font-bold tracking-tight shadow-md hover:opacity-90">
                    Student Records
                 </Button>
