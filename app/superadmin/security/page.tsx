        ...
        <div className="lg:col-span-2 space-y-6">
          <Card className="border-border shadow-sm bg-white overflow-hidden text-left">
            <CardHeader className="bg-slate-50/50 border-b border-border flex flex-row items-center justify-between p-4 px-6">
              ...
              <Button variant="outline" size="sm" className="h-8 bg-white text-[10px] font-black uppercase">
                Global Refresh
              </Button>
            </CardHeader>
              ...
              <div className="divide-y divide-slate-100">
                {securityPolices.map((policy, idx) => (
                  <div key={idx} className="p-6 flex items-center justify-between group hover:bg-slate-50 transition-colors">
                    <div className="flex flex-col gap-1">
                      <div className="flex items-center gap-2">
                        <span className={cn("text-[9px] font-black uppercase tracking-widest", policy.level === "Critical" ? "text-red-500" : policy.level === "High" ? "text-amber-500" : "text-blue-500")}>{policy.level} Impact</span>
                      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="border-border shadow-sm bg-white p-6 border-l-4 border-l-[var(--color-primary)]">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h4 className="text-lg font-black text-slate-900 uppercase">Biometric Auth</h4>
              </div>
              <p className="text-xs text-slate-500 font-medium leading-relaxed mb-6">Enable WebAuthn for hardware-level security keys and platform authenticators.</p>
            ...
            <Card className="border-border shadow-sm bg-white p-6 border-l-4 border-l-emerald-500">
              <div className="flex items-center gap-4 mb-6">
                ...
                <h4 className="text-lg font-black text-slate-900 uppercase">Threat Shield</h4>
              </div>
              <p className="text-xs text-slate-500 font-medium leading-relaxed mb-6">Real-time brute force protection and anomaly detection is active.</p>
        ...
        <div className="space-y-6">
          <Card className="border-border shadow-sm bg-slate-900 text-white overflow-hidden">
            <div className="p-6">
              ...
              <p className="text-xs text-slate-400 font-medium leading-relaxed mb-8">In case of a detected breach, Lockdown Mode immediately terminates all sessions and requires physical admin token to reset.</p>
          ...
          <Card className="border-border shadow-sm bg-white overflow-hidden">
            ...
            <CardContent className="p-0">
                  ...
                  <div key={idx} className="p-4 flex flex-col gap-2">
                    <div className="flex justify-between items-start">
                      ...
                      {s.current ? (
                        ...
                        <Button variant="ghost" size="sm" className="h-6 px-2 text-[8px] font-black uppercase text-red-500 bg-red-50">
                          Revoke
                        </Button>
                      )}
                    </div>
              ...
              <Button variant="ghost" className="w-full h-11 text-[9px] font-black uppercase tracking-widest text-slate-400 hover:text-red-600 border-t border-slate-50">
