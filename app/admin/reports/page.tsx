    ...
    <div className="flex flex-col gap-6 text-left">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card className="border-border shadow-sm bg-white p-6 flex flex-col gap-1 text-left">
           ...
           <p className="text-3xl font-black text-slate-900 tracking-tighter">4,289</p>
        ...
        <Card className="border-border shadow-sm bg-white p-6 flex flex-col gap-1 text-left">
           ...
           <p className="text-3xl font-black text-slate-900 tracking-tighter">356</p>
        ...
        <Card className="border-border shadow-sm bg-white p-6 flex flex-col gap-1 text-left">
           ...
           <p className="text-3xl font-black text-slate-900 tracking-tighter">3.12</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
         <Card className="lg:col-span-2 border-border shadow-sm bg-white overflow-hidden flex flex-col">
            <CardHeader className="bg-slate-50/50 border-b border-border p-4 px-6 flex flex-row items-center justify-between">
               ...
               <div className="flex items-center gap-2">
                  <Button variant="outline" size="sm" className="h-8 bg-white text-[10px] font-black">LAST 30 DAYS</Button>
               </div>
            </CardHeader>
            ...
            <Card className="border-border shadow-sm bg-white">
               ...
               <CardContent className="p-6 space-y-4">
                  <div className="space-y-2">
                     ...
                     <Button variant="outline" className="w-full justify-between h-11 bg-slate-50 border-border text-xs font-bold font-italic">Select Dimension <Filter className="h-4 w-4" /></Button>
                  </div>
                  <div className="space-y-2">
                     <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Time Period</label>
                     <Button variant="outline" className="w-full justify-between h-11 bg-slate-50 border-border text-xs font-bold font-italic">Semester: Spring 2026 <Calendar className="h-4 w-4" /></Button>
                  </div>
            ...
            <Card className="border-border shadow-sm bg-emerald-50 border-emerald-100 overflow-hidden">
               <CardContent className="p-6 text-left flex flex-col gap-4">
                  ...
                  <p className="text-xs text-emerald-700 font-medium leading-relaxed">
                     Attendance marking compliance reached 98.4% this morning across all faculties.
                  </p>
                  <Button variant="ghost" className="w-full h-10 text-[9px] font-black uppercase tracking-widest text-emerald-600 hover:bg-emerald-100">View Detailed Audit</Button>
               </CardContent>
            </Card>
         </div>
      </div>
